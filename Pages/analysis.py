...
def show_analysis():
    ...
    **Interpretation:**  
    ...
    st.image("path_to_hurricane_screenshot.png")  # Replace or delete as needed
    st.markdown("---")
    ...
    **Interpretation:**  
    ...
    st.image("path_to_winter_screenshot.png")
    st.markdown("---")
    ...
    **Interpretation:**  
    ...
    st.image("path_to_wildfire_screenshot.png")
    st.markdown("---")
    ...
    **Interpretation:**  
    ...
    st.image("path_to_flood_screenshot.png")
    st.markdown("---")
